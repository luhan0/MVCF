...
%% ============ Visualization ========================
XX=X{1}; %view#1
plot(XX(label == 1, 1), XX(label == 1, 2),'.r', 'MarkerSize', 10); hold on;
plot(XX(label == 2, 1), XX(label == 2, 2),'.b', 'MarkerSize', 10); hold on;
plot(XX(label == 3, 1), XX(label == 3, 2),'.k', 'MarkerSize', 10); hold on;
set(gca,'fontsize',14);
